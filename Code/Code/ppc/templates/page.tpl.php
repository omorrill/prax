...
<div class="hero-image-page-<?php echo rand(0, 2); ?>" role="banner">
  <div class="container">
...
<div class="main-container top-spacer <?php print $container_class; ?>">
  ...
  <div class="row">
    ...
    <section class="col-sm-8 <?php if (empty($page['sidebar_first'])): ?><?php echo 'col-sm-offset-2'; ?><?php endif; ?>">
